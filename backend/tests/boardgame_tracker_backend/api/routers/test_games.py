...
class TestCreateGame:
    ...
    def test_create_game_success(self, client: TestClient, normal_player_token_headers: dict[str, str]) -> None:
        game_data = {
            "name": "Catan",
            "min_players": 3,
            "max_players": 4,
        ...
        response = client.post(games_endpoint, json=game_data, headers=normal_player_token_headers)
    ...
    def test_create_game_already_exists(self, client: TestClient, normal_player_token_headers: dict[str, str]) -> None:
        game_data = {
            "name": "Catan",
            "min_players": 3,
            "max_players": 4,
    ...
    def test_create_game_missing_name(self, client: TestClient, normal_player_token_headers: dict[str, str]) -> None:
        game_data = {
            "min_players": 2,
            "max_players": 4,
...
class TestListGames:
    ...
    def test_list_games_with_games(self, client: TestClient, normal_player_token_headers: dict[str, str]) -> None:
        game_data_1 = {
            "name": "Catan",
            "min_players": 3,
            "max_players": 4,
        ...
        client.post(games_endpoint, json=game_data_1, headers=normal_player_token_headers)
        client.post(games_endpoint, json=game_data_2, headers=normal_player_token_headers)
